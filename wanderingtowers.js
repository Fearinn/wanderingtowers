...
var WanderingTowers = /** @class */ (function (_super) {
    ...
    WanderingTowers.prototype.setup = function (gamedatas) {
        ...
        var zoomManager = new ZoomManager({
            ...
            zoomLevels: [
                0.6, 0.625, 0.75, 0.875, 1, 1.125, 1.25, 1.375, 1.5, 1.75, 2,
            ],
            defaultZoom: window.innerWidth <= 400 ? 0.6 : 1,
        });
...
var NotificationManager = /** @class */ (function () {
    ...
    NotificationManager.prototype.notif_disablePlayer = function (args) {
        var player_id = args.player_id;
