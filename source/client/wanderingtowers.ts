...
/**
 * See {@link ../../node_modules/.pnpm/bga-ts-template@2.0.6/node_modules/bga-ts-template/docs/typescript/index.md} for a LOT more information on this file.
 * The file include alternative ways to structure this file, how to break it up into multiple files, and more.
 */

// Defines the name of this module. Same as putting this code into a file at path: bgagame/wanderingtowers.ts
/// <amd-module name="bgagame/wanderingtowers"/>
...
// The global 'bgagame.wanderingtowers' class is instantiated when the page is loaded and used as the Gamegui.
